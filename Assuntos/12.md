...
5. Faça uma função que recebe uma string e transforma cada sequência de espaços encontrada em um único espaço. Por exemplo, se receber a string ```"excesso  de   espaco"```, deve alterá-la para que fique ```"excesso de espaco"```.
