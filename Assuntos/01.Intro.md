...
Para que a tradução possa ser feita, a linguagem tem que ser suficientemente simples e não ambígua, o que elimina as linguagens naturais. Milhares de linguagens de programação já foram inventadas, porque não se conseguiu ainda desenvolver uma linguagem em que se consiga expressar com a mesma facilidade todos as formas de se programar ou todas os tipos de problemas em que os computadores são utilizados.
Nesta disciplina, será utilizada em uma dessas linguagens, chamada "C".
